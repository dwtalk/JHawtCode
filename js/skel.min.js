/* skelJS v0.4.41-dev | (c) n33 | skeljs.org | MIT licensed */
...
containers:1200},"1000px":{range:"481-1200",containers:960}}}},defaults:{breakpoint:{test:null,config:null,elements:null},config_breakpoint:{range:"",containers:960,lockViewport:!1,viewportWidth:!1,hasStyleSheet:!0,grid:{}}},DOMReady:null,getElementsByClassName:null,indexOf:null,iterate:null,extend:function(b,d){a.iterate(d,function(c){"object"==typeof d[c]?("object"!=typeof b[c]&&(b[c]={}),a.extend(b[c],d[c])):b[c]=d[c]})},parseMeasurement:function(a){var d;"string"!==typeof a?a=[a,"px"]:"fluid"==
...
a.parseMeasurement(c.config.containers);b=f[0];f=f[1];c.values.containers=b+f;g="iC"+b+f;if(!(h=a.getCachedElement(g))){var m;m=b+f;h=a.cacheElement(g,a.newInline("body{min-width:"+m+"}.container{margin-left:auto;margin-right:auto;width:"+m+"}.container.small{width:"+(0.75*b+f)+"}.container.big{width:100%;max-width:"+(1.25*b+f)+";min-width:"+m+"}"),"head",3)}c.elements.push(h);g="iG";(h=a.getCachedElement(g))||(h=a.cacheElement(g,a.newInline(a.css.g+a.css.gF),"head",3));c.elements.push(h);g="iGG"+
c.config.grid.gutters;if(!(h=a.getCachedElement(g))){var n,p,q;f=a.parseMeasurement(c.config.grid.gutters);b=f[0];n=f[1];f=b+n;m=b/2+n;p=b/4+n;q=1.5*b+n;b=2*b+n;h=a.cacheElement("iGG"+c.config.grid.gutters,a.newInline(".row>*{padding:"+f+" 0 0 "+f+"}.row+.row>*{padding-top:"+f+"}.row{margin-left:-"+f+"}.row.half>*{padding:"+m+" 0 0 "+m+"}.row.half+.row.half>*{padding-top:"+m+"}.row.half{margin-left:-"+m+"}.row.quarter>*{padding:"+p+" 0 0 "+p+"}.row.quarter+.row.quarter>*{padding-top:"+p+"}.row.quarter{margin-left:-"+
p+"}.row.oneandhalf>*{padding:"+q+" 0 0 "+q+"}.row.oneandhalf+.row.oneandhalf>*{padding-top:"+q+"}.row.oneandhalf{margin-left:-"+q+"}.row.double>*{padding:"+b+" 0 0 "+b+"}.row.double+.row.double>*{padding-top:"+b+"}.row.double{margin-left:-"+b+"}"),"head",3)}c.elements.push(h);if(c.config.grid.collapse){if(b=parseInt(c.config.grid.collapse),isNaN(b)&&(b=1),g="iGC"+b,!(h=a.getCachedElement(g))){l=a.css.gR+a.css.gC;k=":not(.no-collapse)";switch(b){case 4:break;case 3:k+=":not(.no-collapse-3)";break;
case 2:k+=":not(.no-collapse-2):not(.no-collapse-3)";break;default:k+=":not(.no-collapse-1):not(.no-collapse-2):not(.no-collapse-3)"}l=l.replace(/@/g,k);h=a.cacheElement(g,a.newInline(l+".container{max-width:none!important;min-width:0!important;width:"+c.values.containers+"!important}"),"head",3)}}else g="iGNoCo",(h=a.getCachedElement(g))||(h=a.cacheElement(g,a.newInline(a.css.gR),"head",3));c.elements.push(h);g="iCd"+a.stateId;(h=a.getCachedElement(g))||(l=[],k=[],a.iterate(a.breakpoints,function(b){-1!==
a.indexOf(d,b)?l.push(".not-"+b):k.push(".only-"+b)}),b=(0<l.length?l.join(",")+"{display:none!important}":"")+(0<k.length?k.join(",")+"{display:none!important}":""),h=a.cacheElement(g,a.newInline(b.replace(/\.([0-9])/,".\\3$1 ")),"head",3),c.elements.push(h));a.iterate(d,function(b){a.breakpoints[d[b]].config.hasStyleSheet&&a.config.prefix&&(g="ss"+d[b],(h=a.getCachedElement(g))||(h=a.cacheElement(g,a.newStyleSheet(a.config.prefix+"-"+d[b]+".css"),"head",5)),c.elements.push(h));0<a.breakpoints[d[b]].elements.length&&
a.iterate(a.breakpoints[d[b]].elements,function(f){c.elements.push(a.breakpoints[d[b]].elements[f])})})}a.detachAllElements();a.attachElements(c.elements);a.DOMReady(function(){var b,d;a.config.useRTL&&(a.unreverseRows(),c.config.grid.collapse&&a.reverseRows(c.config.grid.collapse));(b=a.getElementsByClassName("skel-cell-important"))&&0<b.length&&(c.config.grid.collapse?a.iterate(b,function(a){"length"!==a&&(e=b[a],e.hasOwnProperty("_skel_cell_important_placeholder")&&!1!==e._skel_cell_important_placeholder||
(d=document.createElement("div"),d.innerHTML="",d.style.display="none",e.parentNode.insertBefore(d,e.nextSibling),e.parentNode.insertBefore(e,e.parentNode.firstChild),e._skel_cell_important_placeholder=d))}):a.iterate(b,function(a){e=b[a];"length"!==a&&(e.hasOwnProperty("_skel_cell_important_placeholder")||(e._skel_cell_important_placeholder=!1),d=e._skel_cell_important_placeholder,!1!==d&&(e.parentNode.insertBefore(e,d),e.parentNode.removeChild(d),e._skel_cell_important_placeholder=!1))}))});a.vars.state=
...
{range:a.config.breakpoints[f]});d={};a.extend(d,a.defaults.config_breakpoint);a.extend(d,a.config.breakpoints[f]);a.config.breakpoints[f]=d;c={};a.extend(c,a.defaults.breakpoint);c.config=a.config.breakpoints[f];c.test=b(f,c.config.range);c.elements=[];a.breakpoints[f]=c;a.config.preloadStyleSheets&&c.config.hasStyleSheet&&g.push(a.config.prefix+"-"+f+".css");a.breakpointList.push(f)});a.iterate(a.config.events,function(b){a.bind(b,a.config.events[b])});0<g.length&&"file:"!=window.location.protocol&&
a.DOMReady(function(){document.getElementsByTagName("head");var b=new XMLHttpRequest;a.iterate(g,function(a){b.open("GET",g[a],!1);b.send("")})})},initEvents:function(){a.config.pollOnce||(window.onresize=function(){a.poll()},a.config.useOrientation&&(window.onorientationchange=function(){a.poll()}))},initUtilityMethods:function(){(function(){var b=window,d=function(a){f=!1;d.isReady=!1;"function"===typeof a&&h.push(a);a=!1;if(!f)if(f=!0,"loading"!==c.readyState&&l(),c.addEventListener)c.addEventListener("DOMContentLoaded",
g,!1),b.addEventListener("load",g,!1);else if(c.attachEvent){c.attachEvent("onreadystatechange",g);b.attachEvent("onload",g);try{a=null==b.frameElement}catch(n){}c.documentElement.doScroll&&a&&k()}},c=b.document,f=!1,h=[],g=function(){c.addEventListener?c.removeEventListener("DOMContentLoaded",g,!1):c.detachEvent("onreadystatechange",g);l()},l=function(){if(!d.isReady){if(!c.body)return setTimeout(l,1);d.isReady=!0;a.iterate(h,function(a){h[a]()});h=[]}},k=function(){if(!d.isReady){try{c.documentElement.doScroll("left")}catch(a){setTimeout(k,
...
for(0>c&&(c=f-Math.abs(c));c<f;c++)if(this[c]===a)return c;return-1};a.iterate=Object.keys?function(a,d){if(!a)return[];var c,f=Object.keys(a);for(c=0;f[c];c++)d(f[c])}:function(a,d){if(!a)return[];for(var c in a)Object.prototype.hasOwnProperty.call(a,c)&&d(c)}},initAPI:function(){var b,d,c=navigator.userAgent;a.vars.IEVersion=c.match(/MSIE ([0-9]+)\./)?RegExp.$1:99;a.vars.isTouch=!!("ontouchstart"in window);a.vars.deviceType="other";d={ios:"(iPad|iPhone|iPod)",android:"Android",mac:"Macintosh",windows:"Windows NT"};
a.iterate(d,function(b){c.match(RegExp(d[b],"g"))&&(a.vars.deviceType=b)});switch(a.vars.deviceType){case "ios":c.match(/([0-9_]+) like Mac OS X/);b=parseFloat(RegExp.$1.replace("_",".").replace("_",""));break;case "android":c.match(/Android ([0-9\.]+)/);b=parseFloat(RegExp.$1);break;case "mac":c.match(/Mac OS X ([0-9_]+)/);b=parseFloat(RegExp.$1.replace("_",".").replace("_",""));break;case "windows":c.match(/Windows NT ([0-9\.]+)/);b=parseFloat(RegExp.$1);break;default:b=99}a.vars.deviceVersion=
